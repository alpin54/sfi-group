...
// -- style
import style from '@components/Product/ProductList/styles/style.module.scss';
...
import Breadcrumb from '@components/Elements/Breadcrumb/views';
...
const ProductList = (props) => {
  const { data, category, subCategory, brandOptions, sortOptions, colorOptions, filters, onFilterChange } = props;
        ...
        <div className={style.head}>
          <div className={style.breadcrumb}>
            <Breadcrumb
              items={[
                {
                  text: reverseSlug(category),
                  icon: 'caret-right',
                  href: `/shop/${category}`
                },
                {
                  text: reverseSlug(subCategory),
                  href: `/shop/${category}/${subCategory}`
                }
              ]}
            />
          </div>
          <h3 className={style.title}>{reverseSlug(subCategory)}</h3>
