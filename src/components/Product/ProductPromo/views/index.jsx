...
// -- style
import style from '@components/Product/ProductPromo/styles/style.module.scss';
...
const ProductPromo = (props) => {
  const { data, brandOptions, sortOptions, colorOptions, filters, onFilterChange } = props;
