// -- assets
import ProductA from '@assets/image/dummy/newProduct1.jpg';
import ProductB from '@assets/image/dummy/newProduct2.jpg';

const data = [
  {
    title: 'Trendy Waist Bag',
    description:
