...
// -- components
import ResetPassword from '@components/ResetPassword/views';

const ResetPasswordWidget = async ({ customerId, token }) => {
  ...
  return <ResetPassword customerId={customerId} token={token} data={finalData} />;
};
