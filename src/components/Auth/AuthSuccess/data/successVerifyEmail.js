...
const data = {
  ...
  description: 'Please verify your email to continue your dealer registration.',
  subDescription:
    'We’ve sent a verification link to [email@dummy.com]. Be sure to check your Spam, Promotions, or Recent folders too.'
};
