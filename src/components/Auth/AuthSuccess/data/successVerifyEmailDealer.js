...
const data = {
  ...
  subTitle: 'Please verify your email to continue your dealer registration.',
  description:
    '<p>We’ve sent a verification link to [<a href="mailto:email@dummy.com">email@dummy.com</a>]. Be sure to check your Spam, Promotions, or Recent folders too.</p>'
};
