...
const AuthSuccessWidget = async () => {
  ...
  try {
    const { ready: readyBanner, data: bannerData } = await authSuccessModel.resetPasswordBanner();
    const { ready: readyAbout, data: aboutData } = await authSuccessModel.resetPasswordAbout();
