...
// -- styles
import style from '@components/SignUp/ModalAlert/styles/style.module.scss';
...
const AlertModal = ({
  ...
  const handleCta = () => {
    try {
      ...
      console.error('AlertModal onButtonClick error', err);
    }
    onClose && onClose();
  };
      ...
      <div className={style.panel} role='document' aria-live='assertive'>
        <div className={style.body}>
          <div className={style.iconWrap}>
            <SystemIcon name={icon || 'warning'} className={style.icon} />
          </div>
